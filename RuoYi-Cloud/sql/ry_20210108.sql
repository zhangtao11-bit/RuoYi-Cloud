...
-- ----------------------------
-- Table structure for business_device
-- ----------------------------
...
CREATE TABLE `business_device`  (
  ...
  `memo` blob NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '设备' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of business_device
-- ----------------------------
INSERT INTO `business_device` VALUES (1, 'S001', '电脑1', NULL);
...
-- ----------------------------
INSERT INTO `gen_table` VALUES (3, 'business_device', '设备', NULL, NULL, 'Device', 'crud', 'com.ruoyi.business', 'business', 'device', '设备', 'ruoyi', '0', '/', '{\"parentMenuId\":1066}', 'admin', '2021-01-31 19:50:31', '', '2021-01-31 20:10:21', NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (9, '3', 'id', '主键', 'bigint(20)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2021-01-31 19:50:31', '', '2021-01-31 20:10:21');
INSERT INTO `gen_table_column` VALUES (10, '3', 'code', '设备编码', 'varchar(255)', 'String', 'code', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2021-01-31 19:50:31', '', '2021-01-31 20:10:21');
INSERT INTO `gen_table_column` VALUES (11, '3', 'name', '设备名称', 'varchar(255)', 'String', 'name', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 3, 'admin', '2021-01-31 19:50:31', '', '2021-01-31 20:10:21');
INSERT INTO `gen_table_column` VALUES (12, '3', 'memo', '备注', 'blob', 'String', 'memo', '0', '0', NULL, '1', '1', '1', '1', 'EQ', NULL, '', 4, 'admin', '2021-01-31 19:50:31', '', '2021-01-31 20:10:21');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (1, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-27 20:28:29');
INSERT INTO `sys_logininfor` VALUES (2, 'admin', '192.168.0.115', '0', '退出成功', '2021-01-27 20:44:05');
INSERT INTO `sys_logininfor` VALUES (3, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-27 21:10:08');
INSERT INTO `sys_logininfor` VALUES (4, 'admin', '192.168.0.115', '0', '退出成功', '2021-01-27 21:10:13');
INSERT INTO `sys_logininfor` VALUES (5, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-27 21:48:57');
INSERT INTO `sys_logininfor` VALUES (6, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-27 21:49:12');
INSERT INTO `sys_logininfor` VALUES (7, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-30 19:29:29');
INSERT INTO `sys_logininfor` VALUES (8, 'admin', '192.168.0.115', '0', '退出成功', '2021-01-30 19:57:49');
INSERT INTO `sys_logininfor` VALUES (9, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-30 19:59:31');
INSERT INTO `sys_logininfor` VALUES (10, 'admin', '192.168.0.115', '0', '退出成功', '2021-01-30 20:21:46');
INSERT INTO `sys_logininfor` VALUES (11, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-30 20:22:10');
INSERT INTO `sys_logininfor` VALUES (12, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-31 18:04:49');
INSERT INTO `sys_logininfor` VALUES (13, 'admin', '192.168.0.115', '0', '登录成功', '2021-01-31 18:05:00');
INSERT INTO `sys_logininfor` VALUES (14, 'admin', '192.168.0.115', '0', '登录成功', '2021-02-01 20:25:02');
...
INSERT INTO `sys_menu` VALUES (1066, '业务', 0, 10, 'business', NULL, 1, 0, 'M', '0', '0', NULL, 'education', 'admin', '2021-01-31 20:09:21', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1067, '设备', 1066, 1, 'device', 'business/device/index', 1, 0, 'C', '0', '0', 'business:device:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '设备菜单');
INSERT INTO `sys_menu` VALUES (1068, '设备查询', 1067, 1, '#', '', 1, 0, 'F', '0', '0', 'business:device:query', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (1069, '设备新增', 1067, 2, '#', '', 1, 0, 'F', '0', '0', 'business:device:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (1070, '设备修改', 1067, 3, '#', '', 1, 0, 'F', '0', '0', 'business:device:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (1071, '设备删除', 1067, 4, '#', '', 1, 0, 'F', '0', '0', 'business:device:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (1072, '设备导出', 1067, 5, '#', '', 1, 0, 'F', '0', '0', 'business:device:export', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '通知公告', 2, 'com.ruoyi.system.controller.SysNoticeController.add()', 'POST', 1, 'admin', NULL, '/notice', '127.0.0.1', '', '{\"noticeContent\":\"<p>11111</p>\",\"createBy\":\"admin\",\"noticeType\":\"1\",\"params\":{},\"noticeTitle\":\"1111\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-30 21:23:40');
INSERT INTO `sys_oper_log` VALUES (2, '通知公告', 2, 'com.ruoyi.system.controller.SysNoticeController.edit()', 'PUT', 1, 'admin', NULL, '/notice', '127.0.0.1', '', '{\"noticeContent\":\"<p>11111</p>\",\"createBy\":\"admin\",\"createTime\":1612013018000,\"updateBy\":\"admin\",\"noticeType\":\"2\",\"params\":{},\"noticeId\":3,\"noticeTitle\":\"1111\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-30 21:24:13');
INSERT INTO `sys_oper_log` VALUES (3, '通知公告', 3, 'com.ruoyi.system.controller.SysNoticeController.remove()', 'DELETE', 1, 'admin', NULL, '/notice/3', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-30 21:24:24');
INSERT INTO `sys_oper_log` VALUES (4, '代码生成', 6, 'com.ruoyi.gen.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/gen/importTable', '127.0.0.1', '', 'business_device', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:46:13');
INSERT INTO `sys_oper_log` VALUES (5, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:46:18');
INSERT INTO `sys_oper_log` VALUES (6, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:46:23');
INSERT INTO `sys_oper_log` VALUES (7, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:46:26');
INSERT INTO `sys_oper_log` VALUES (8, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:48:09');
INSERT INTO `sys_oper_log` VALUES (9, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:48:10');
INSERT INTO `sys_oper_log` VALUES (10, '代码生成', 3, 'com.ruoyi.gen.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/gen/1', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:48:13');
INSERT INTO `sys_oper_log` VALUES (11, '代码生成', 6, 'com.ruoyi.gen.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/gen/importTable', '127.0.0.1', '', 'business_device', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:48:18');
INSERT INTO `sys_oper_log` VALUES (12, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:48:20');
INSERT INTO `sys_oper_log` VALUES (13, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:48:26');
INSERT INTO `sys_oper_log` VALUES (14, '代码生成', 2, 'com.ruoyi.gen.controller.GenController.synchDb()', 'GET', 1, 'admin', NULL, '/gen/synchDb/business_device', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:48:39');
INSERT INTO `sys_oper_log` VALUES (15, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:49:40');
INSERT INTO `sys_oper_log` VALUES (16, '代码生成', 2, 'com.ruoyi.gen.controller.GenController.synchDb()', 'GET', 1, 'admin', NULL, '/gen/synchDb/business_device', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:50:14');
INSERT INTO `sys_oper_log` VALUES (17, '代码生成', 3, 'com.ruoyi.gen.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/gen/2', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:50:24');
INSERT INTO `sys_oper_log` VALUES (18, '代码生成', 6, 'com.ruoyi.gen.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/gen/importTable', '127.0.0.1', '', 'business_device', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:50:31');
INSERT INTO `sys_oper_log` VALUES (19, '代码生成', 6, 'com.ruoyi.gen.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/gen/importTable', '127.0.0.1', '', 'sys_dept', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:50:55');
INSERT INTO `sys_oper_log` VALUES (20, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:50:58');
INSERT INTO `sys_oper_log` VALUES (21, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:51:01');
INSERT INTO `sys_oper_log` VALUES (22, '代码生成', 3, 'com.ruoyi.gen.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/gen/4', '127.0.0.1', '', NULL, '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 19:51:32');
INSERT INTO `sys_oper_log` VALUES (23, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 19:55:01');
INSERT INTO `sys_oper_log` VALUES (24, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:56:35');
INSERT INTO `sys_oper_log` VALUES (25, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 19:56:41');
INSERT INTO `sys_oper_log` VALUES (26, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 674, column 0]', '2021-01-31 19:57:25');
INSERT INTO `sys_oper_log` VALUES (27, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 674, column 0]', '2021-01-31 19:57:35');
INSERT INTO `sys_oper_log` VALUES (28, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 19:58:15');
INSERT INTO `sys_oper_log` VALUES (29, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 19:59:37');
INSERT INTO `sys_oper_log` VALUES (30, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 19:59:49');
INSERT INTO `sys_oper_log` VALUES (31, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 20:02:22');
INSERT INTO `sys_oper_log` VALUES (32, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 1, 'Lexical error,   Encountered: <EOF> after : \"\" at vm/vue/index.vue.vm[line 673, column 10]', '2021-01-31 20:04:13');
INSERT INTO `sys_oper_log` VALUES (33, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 20:06:23');
INSERT INTO `sys_oper_log` VALUES (34, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"visible\":\"0\",\"icon\":\"education\",\"orderNum\":\"10\",\"menuName\":\"业务\",\"params\":{},\"parentId\":0,\"isCache\":\"0\",\"path\":\"business\",\"createBy\":\"admin\",\"children\":[],\"isFrame\":\"1\",\"menuType\":\"M\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 20:09:24');
INSERT INTO `sys_oper_log` VALUES (35, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', NULL, 'null', 0, NULL, '2021-01-31 20:10:26');
INSERT INTO `sys_oper_log` VALUES (36, '设备', 1, 'com.ruoyi.business.controller.DeviceController.add()', 'POST', 1, 'admin', NULL, '/device', '127.0.0.1', '', '{\"code\":\"S001\",\"name\":\"电脑\",\"id\":1,\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 20:33:39');
INSERT INTO `sys_oper_log` VALUES (37, '设备', 2, 'com.ruoyi.business.controller.DeviceController.edit()', 'PUT', 1, 'admin', NULL, '/device', '127.0.0.1', '', '{\"code\":\"S001\",\"name\":\"电脑1\",\"id\":1,\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-01-31 20:33:46');
